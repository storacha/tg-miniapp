      ...
      <div className="rounded-t-xl w-full flex-grow py-2">
        ...
        >
          <div className="flex space-x-2 items-center gap-2 border-b border-primary/10">
            ...
            <Label htmlFor="twoWeeks" className="flex-auto py-4">
              Last 2 weeks
            </Label>
          </div>
          <div className="flex space-x-2 items-center gap-2 border-b border-primary/10">
            <RadioGroupItem value="month" id="month" />
            <Label htmlFor="month" className="flex-auto py-4">
              Last month
            </Label>
          </div>
          <div className="flex space-x-2 items-center gap-2 border-b border-primary/10">
            <RadioGroupItem value="sixMonths" id="sixMonths" />
            <Label htmlFor="sixMonths" className="flex-auto py-4">
              Last 6 months
            </Label>
          </div>
          <div className="flex space-x-2 items-center gap-2 border-b border-primary/10">
            <RadioGroupItem value="allTime" id="allTime" />
            <Label htmlFor="allTime" className="flex-auto py-4">
              All time
            </Label>
          </div>
        </RadioGroup>
